...
% set run parameters
runID     =  '2D_MtAp_N100';           % run identifier
outdir    =  '/mnt/home/2388600c/sharedscratch/mtap/out2';
...
c0        =  [12.9000   18.8000   12.3000   16.4000   39.6000  4    2]/100;  % *** components (maj comp, H2O) top  layer [wt] (will be normalised to unit sum!)

...
dx0       =  0.003;
df0       =  0.0003;
L0        =  2*(D/200);               % correlation length for eddy diffusivity (multiple of h, 0.5-1)
l0x       =  2*dx0*20;              % correlation length for xtal  phase fluctuation diffusivity (multiple of d0, 10-20)
l0f       =  2*df0*20;              % correlation length for fluid phase fluctuation diffusivity (multiple of d0, 10-20)

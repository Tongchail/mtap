...
L0        =  (1/2)*h/2;           % correlation length for eddy diffusivity (multiple of h, 0.5-1)
l0x       =  (1/2)*dx0*10;        % correlation length for xtal  phase fluctuation diffusivity (multiple of d0, 10-20)
l0f       =  (1/2)*df0*10;        % correlation length for fluid phase fluctuation diffusivity (multiple of d0, 10-20)

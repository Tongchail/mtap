...
init_mode = 'linear';              % T initial condition mode ('layer' or 'linear')
...
l0m       =  dm0*20;              % correlation length for melt  phase fluctuation diffusivity (multiple of d0, 10-20)

...
% set run parameters
runID     =  '2D_MtAp_N60';       % run identifier
outdir    =  '../out';%'/mnt/home/2388600c/sharedscratch/mtap/out2';
...
c0        =  [12.9  18.8  12.3  16.4  39.6  4   2]/100;  % *** components (maj comp, H2O) top  layer [wt] (will be normalised to unit sum!)
...
bnd_w     =  D/120;               % boundary layer width [m]
tau_T     =  (D/120)^2/1e-6;      % wall cooling time [s]
